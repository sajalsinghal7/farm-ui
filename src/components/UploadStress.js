...
class UploadStress extends Component {
  constructor(props) {
    super(props);
    this.state = { 
  ...
  handleSubmit = (event) => {
    ...
    fetch('http://localhost:8080/api/v1/stressModel/upload', {
        method: 'POST',
  ...
  render() {
    return (
        <div>
          <h2>Stress File Upload</h2>
          <h1>File Format- YYYYMMDD, ETO</h1>
